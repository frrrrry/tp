...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("new user")]),_v(" "),_c('td',[_v("see usage instructions")]),_v(" "),_c('td',[_v("refer to instructions when I forget how to use the App")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("add my classmates, professors and teaching assistants profiles in")]),_v(" "),_c('td',[_v("easily keep track of my peers and mentors in NUS")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("my classmates, professors or teaching assistants profiles")]),_v(" "),_c('td',[_v("remove entries that I no longer need")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("search a profile by name")]),_v(" "),_c('td',[_v("locate details of a person without having to go through the entire list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("view the list of profiles added")]),_v(" "),_c('td')]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("favourite profiles I would view often")]),_v(" "),_c('td',[_v("easily view their profiles when using the app")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("close the app when I am done using it")]),_v(" "),_c('td')]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * ")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("save my favourite professors, teaching assistants, and classmates in a personal contact list within NUSearch")]),_v(" "),_c('td',[_v("reach out to them easily in the future")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * ")])]),_v(" "),_c('td',[_v("Professor")]),_v(" "),_c('td',[_v("include my don’t disturb timings I can reach out to them easily in the future")]),_v(" "),_c('td',[_v("so that I can have better work life balance")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * ")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("delete my classmates, professors or teaching assistants profiles")]),_v(" "),_c('td',[_v("I can remove entries I no longer need")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*  ")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("find the direction to my tutorial / lecture classrooms")]),_v(" "),_c('td',[_v("I will not get lost on campus.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NUSearch")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("User")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("System: NUSearch")]),_v(" "),_c('strong',[_v("Use case: UC1 - Add a new profile")]),_v(" "),_c('strong',[_v("Actor: User")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User input a new profile")]),_v(" "),_c('li',[_v("NUSearch adds the new profile to the list\nUse case ends")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. NUSearch detects an error in the input data")]),_v(" "),_c('li',[_c('ul',[_c('li',[_v("1a1. NUSearch requests for the correct data")])])]),_v(" "),_c('li',[_v("Use case ends")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("System: NUSearch")]),_v(" "),_c('strong',[_v("Use case: UC2 - Asking for help")]),_v(" "),_c('strong',[_v("Actor: User")]),_v(" "),_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests for help")]),_v(" "),_c('li',[_v("NUSearch sends the help")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("System: NUSearch")]),_v(" "),_c('strong',[_v("Use case: UC3 - Asking for List")]),_v(" "),_c('strong',[_v("Actor: User")]),_v(" "),_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests for the list of profiles")]),_v(" "),_c('li',[_v("NUSearch sends the list of profiles")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. NUSearch detects no data in the list")]),_v(" "),_c('li',[_c('ul',[_c('li',[_v("1a1. NUSearch tells the user the list is empty")])])]),_v(" "),_c('li',[_v("Use case ends")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("System: NUSearch")]),_v(" "),_c('strong',[_v("Use case: UC4 - Exit")]),_v(" "),_c('strong',[_v("Actor: User")]),_v(" "),_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests for an exit")]),_v(" "),_c('li',[_v("NUSSearch exits")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("System: NUSearch")]),_v(" "),_c('strong',[_v("Use case: UC5 - Add favorite")]),_v(" "),_c('strong',[_v("Actor: User")]),_v(" "),_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User favorites a profile")]),_v(" "),_c('li',[_v("NUSearch favorites the profile")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1b. The profile does not exists")]),_v(" "),_c('li',[_c('ul',[_c('li',[_v("1b1. NUSearch tells the user the profile does not exists")])])]),_v(" "),_c('li',[_v("Use case ends")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("System: NUSearch")]),_v(" "),_c('strong',[_v("Use case: UC6 - Search for a profile")]),_v(" "),_c('strong',[_v("Actor: User")]),_v(" "),_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests for a profile")]),_v(" "),_c('li',[_v("NUSearch shows the profile")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("11")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 persons without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("The system should store data in a human-editable text file, in a human-readable format.")]),_v(" "),_c('li',[_v("The system should work without requiring an installer.")]),_v(" "),_c('li',[_v("The system should not depend on a remote server.")]),_v(" "),_c('li',[_v("The GUI should not cause any resolution-related inconveniences for a user for standard screen resolutions 1920x1080 or higher.")]),_v(" "),_c('li',[_v("The GUI should not cause any resolution-related inconveniences for a user at screen scales 100% or 125%.")]),_v(" "),_c('li',[_v("The GUI should be usable at standard screen resolutions 1280x720 or higher.")]),_v(" "),_c('li',[_v("The GUI should be usable at screen scale 150%.")]),_v(" "),_c('li',[_v("The system should be packaged into a single JAR file.")]),_v(" "),_c('li',[_v("The JAR file containing the system should not exceed 100MB in size.")]),_v(" "),_c('li',[_v("The system should not take more than 2 seconds to process any given command.")]),_v(" "),_c('li',[_v("The GUI should be easy to navigate for an experienced user of the system.")]),_v(" "),_c('li',[_v("The system should generally follow the object-oriented paradigm.")]),_v(" "),_c('li',[_v("It should be easy to incorporate new commands, attributes or fields into the system.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('strong',[_v("API")]),_v(": Application Programming Interface, a set of rules and protocols that allow different software applications to communicate with each other")]),_v(" "),_c('li',[_c('strong',[_v("Architecture Diagram")]),_v(": Visual representation that illustrates how various components of the software project are structured and interconnected")]),_v(" "),_c('li',[_c('strong',[_v("JavaFX UI")]),_v(": A user interface framework in Java for creating interactive and visually appealing desktop applications")]),_v(" "),_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, OS-X")]),_v(" "),_c('li',[_c('strong',[_v("PlantUML")]),_v(": A text-based tool for creating diagrams using simple text descriptions")]),_v(" "),_c('li',[_c('strong',[_v("Sequence Diagram")]),_v(": A visual tool showing the order of actions between system components or objects")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
